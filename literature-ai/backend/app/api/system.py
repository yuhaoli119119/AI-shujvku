...
async def get_agent_guide() -> dict:
    ...
    return {
        ...
        "legacy_suggested_client_prompt": (
            ...
            "Use review_figure when the task is to record a figure verdict such as verified, needs_repair, or rejected; use import_analysis when the task is to correct figure_role, content_summary, key_elements, page, or caption metadata. "
