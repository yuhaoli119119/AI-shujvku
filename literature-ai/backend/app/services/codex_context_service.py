...
class CodexContextService:
    ...
    def _build_item_markdown(self, context: dict[str, Any]) -> str:
        ...
        lines = [
            ...
            "- Treat the DFT audit center as a read-only queue and navigation entry. Final DFTResult verify/reject belongs on the DFT detail page or an explicit user-authorized review tool; legacy AI adjudication and auto-advance flows must not be used as DFT final truth.",
