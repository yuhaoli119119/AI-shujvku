...
class CodexContextService:
    ...
    def _build_item_markdown(self, context: dict[str, Any]) -> str:
        ...
        lines = [
            ...
            "- Primary AI may read get_dft_audit_issues and call repair_dft_audit_issue for one issue_id at a time. Audit AI must not call the repair tool, and primary-AI repair is not human_verified, safe_verified, or ML_Ready.",
