...
def _extract_evidence_context(payload: Any) -> dict[str, Any]:
    ...
    return {
        ...
        "active_site_instance_key": _context_text(_get_payload_value(payload, "active_site_instance_key")),
        "atom_pair": _context_text(_get_payload_value(payload, "atom_pair")),
        "site_label": _context_text(_get_payload_value(payload, "site_label")),
        "state_context": _context_text(_get_payload_value(payload, "state_context")),
        "metal_center_1": _context_text(_get_payload_value(payload, "metal_center_1")),
        "metal_center_2": _context_text(_get_payload_value(payload, "metal_center_2")),
        "source_table_id": _context_text(_get_payload_value(payload, "source_table_id")),
        "source_row_index": _context_text(_get_payload_value(payload, "source_row_index")),
        "source_column_index": _context_text(_get_payload_value(payload, "source_column_index")),
...
def _target_context_key(
    *,
    ...
    instance_specific_values = (
        ...
        evidence_context.get("active_site_instance_key"),
        evidence_context.get("atom_pair"),
        evidence_context.get("site_label"),
        evidence_context.get("state_context"),
...
def _build_instance_context(
    *,
    ...
    components = {
        ...
        "active_site_instance_key": evidence_context.get("active_site_instance_key"),
        "atom_pair": evidence_context.get("atom_pair"),
        "site_label": evidence_context.get("site_label"),
        "state_context": evidence_context.get("state_context"),
        "metal_center_1": evidence_context.get("metal_center_1"),
        "metal_center_2": evidence_context.get("metal_center_2"),
        "source_table_id": evidence_context.get("source_table_id"),
        "source_row_index": evidence_context.get("source_row_index"),
        "source_column_index": evidence_context.get("source_column_index"),
    ...
    material_scope_key = "|".join(
        [
            ...
            f"active_site={_context_token(components['active_site_instance_key'])}",
            f"atom_pair={_context_token(components['atom_pair'])}",
            f"site_label={_context_token(components['site_label'])}",
            f"state={_context_token(components['state_context'])}",
    ...
    instance_anchor_key = "|".join(
        [
            ...
            f"row={_context_token(components.get('source_row_index'))}",
            f"col={_context_token(components.get('source_column_index'))}",
        ]
    )
    instance_key = "|".join(
        [
    ...
    for dr, paper in rows:
        ...
        writer.writerow(
            [
                ...
                dr.value_upper if dr.value_upper is not None else "",
                dr.value_kind or ("range" if dr.value_upper is not None else "point"),
                display_unit or "",
