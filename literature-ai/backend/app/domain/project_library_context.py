...
_CONTEXTS = MappingProxyType(
    {
        "li_s_sac_dac": ProjectLibraryContext(
            ...
            prompt_hints=(
                ...
                "属性必须绑定 catalyst_sample_id；active_site_ref 或 active_site_instance_key 是可选细粒度上下文，无法安全绑定活性位点时不要阻断同催化剂级拟合。",
                "Bader charge、charge transfer、metal_metal_distance_A、li_s_bond_length_A、coordination_environment、adsorption_site、adsorption_mode 原文明确给出时提取，缺失时保持 null。",
