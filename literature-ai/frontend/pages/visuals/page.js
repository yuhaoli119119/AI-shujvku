(function () {
  ...
  const EXCLUSION_LABELS = {
    ...
    missing_catalyst_sample_id: "记录未明确绑定催化剂样品（可选元数据）",
    missing_catalyst_sample_id_metadata_only: "记录未绑定催化剂样品（仅元数据提示）",
    missing_or_ambiguous_calculation_context: "计算设置缺失或无法唯一关联",
    "safety_gate:missing_material_identity": "历史材料身份门禁（现已取消）",
