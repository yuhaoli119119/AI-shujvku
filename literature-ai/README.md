...
- `paper_workbench_service.py` now delegates review-center status, sorting, supplementary-group, and lightweight DFT audit helpers to `app/services/paper_workbench_review_center.py`, and workspace/source-document/audit/figure file helpers to `app/services/paper_workbench_workspace.py`.
