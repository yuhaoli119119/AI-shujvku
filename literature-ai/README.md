...
|------|-------------|---------------|
| 2026-05-26 | G3B PDF Evidence Jump UI: added evidence locator panel on literature detail page, field-level locator badges on the extraction workbench, PDF viewer overlay with bbox highlighting, locator-status-aware degradation (exact/page_only/text_only/needs_reparse/missing), validate warning priority respecting G2B review target warnings, three API wrapper functions with 404/500 graceful handling, and full Playwright smoke test coverage. PDF evidence jump UI foundation closed for current scope and verified by current Playwright smoke tests. | `frontend/pages/literature_library/render-detail.js`, `frontend/pages/literature_library/api.js`, `frontend/pages/literature_library/index.html`, `frontend/pages/external_analysis_workbench/index.html`, `frontend/tests/smoke.spec.js`, `README.md` |
